...
class LineFollowerBot:
    ...
    def __init__(self,
        ...
        :param robot_config: Configuration dictionary with keys:
                       ...
                       - 'start_yaw': Starting yaw in degree
    ...
    def draw(self, draw_robot=False, surface=None):
        """
        ...
        if draw_robot:
            robot_image = pygame.image.load("agent/robot.png").convert_alpha()
            # Rotate the image to match the orientation of the bot.
            rotated_image = pygame.transform.rotate(robot_image, -np.degrees(self.yaw))
